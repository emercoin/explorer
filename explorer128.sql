...
# Datenbank: explorer.emercoin.com128
# Erstellt am: 2018-03-19 07:54:05 +0000
# ************************************************************
...
CREATE TABLE `blocks` (
  ...
  `merkleroot` varchar(70) DEFAULT NULL,
...
CREATE TABLE `vin` (
  ...
  `asm` varchar(5000) DEFAULT NULL,
  `hex` varchar(5000) DEFAULT NULL,
